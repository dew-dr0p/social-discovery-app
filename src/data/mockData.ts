...
export const mockUsers: User[] = [
  ...
  },
  {
    ...
    age: 25,
    avatar:
      'https://ui-avatars.com/api/?name=Olivia+Williams&background=random',
...
export const generateMockMessages = (userId: string): Message[] => {
  const messageTemplates = {
    '1': [
      ...
      {
        text: 'Yes! I love capturing moments. Do you have a favorite type of photography?',
        isFromCurrentUser: true,
      },
      {
        text: "I'm really into street photography and landscapes. What about you?",
        isFromCurrentUser: false,
      },
      {
        text: "Landscapes are amazing! I've been trying to get into portrait photography lately",
        isFromCurrentUser: true,
      },
      {
        text: "That's awesome! I'd love to see some of your work sometime",
        isFromCurrentUser: false,
      },
      {
        text: 'For sure! Maybe we could go on a photo walk together?',
        isFromCurrentUser: true,
      },
      {
        text: 'That sounds perfect! I know some great spots in the city',
        isFromCurrentUser: false,
      },
      {
        text: 'Great! When would be a good time for you?',
        isFromCurrentUser: true,
      },
      {
        text: 'How about this weekend? The weather should be nice',
        isFromCurrentUser: false,
      },
      {
      ...
      {
        text: 'By the way, do you have any favorite coffee spots?',
        isFromCurrentUser: true,
      },
      {
        text: "Yes! There's this amazing place near the park. We should grab coffee after!",
        isFromCurrentUser: false,
      },
    ],
    '2': [
      // James Rodriguez
      {
        text: "Hey there! I noticed you're a chef 👨‍🍳",
        isFromCurrentUser: false,
      },
      {
        text: "Yes! I love cooking. What's your favorite cuisine?",
        isFromCurrentUser: true,
      },
      {
        text: "I'm really into Italian and Mexican food. What about you?",
        isFromCurrentUser: false,
      },
      {
        text: "Italian is amazing! I've been trying to perfect my pasta making",
        isFromCurrentUser: true,
      },
      {
        text: "That's impressive! Homemade pasta is the best",
        isFromCurrentUser: false,
      },
      {
        text: "It's definitely a labor of love, but so worth it",
        isFromCurrentUser: true,
      },
      {
        text: "I'd love to try your pasta sometime! 😋",
        isFromCurrentUser: false,
      },
      {
        text: "I'd be happy to cook for you! What's your favorite type of pasta?",
        isFromCurrentUser: true,
      },
      {
        text: 'I love ravioli and fettuccine alfredo',
        isFromCurrentUser: false,
      },
      {
        text: 'Great choices! I make a mean mushroom ravioli',
        isFromCurrentUser: true,
      },
      {
        text: 'That sounds incredible! When can I try it? 😍',
        isFromCurrentUser: false,
      },
      {
        text: 'How about this Friday? I could cook dinner',
        isFromCurrentUser: true,
      },
      {
        text: "That sounds perfect! I'll bring some wine",
        isFromCurrentUser: false,
      },
    ...
    '3': [
      // Sophie Chen
      {
        text: "Hi! I saw you're into art and yoga 🧘‍♀️",
        isFromCurrentUser: false,
      },
      {
        text: 'Yes! Both are such great ways to express creativity and find peace',
        isFromCurrentUser: true,
      },
      {
        text: 'I completely agree! Do you have a favorite yoga style?',
        isFromCurrentUser: false,
      },
      {
        text: 'I love vinyasa and yin yoga. What about you?',
        isFromCurrentUser: true,
      },
      {
        text: "I'm really into hot yoga and restorative practices",
        isFromCurrentUser: false,
      },
      {
        text: "That's awesome! Hot yoga is so challenging but rewarding",
        isFromCurrentUser: true,
      },
      {
        text: 'It really is! Maybe we could do a yoga session together sometime?',
        isFromCurrentUser: false,
      },
      {
        text: "I'd love that! Do you have a favorite studio?",
        isFromCurrentUser: true,
      },
      {
        text: "Yes! There's this amazing place downtown with great instructors",
        isFromCurrentUser: false,
      },
      { text: "Perfect! I'd love to check it out", isFromCurrentUser: true },
      {
        text: "Great! I'll send you the details. What's your schedule like?",
        isFromCurrentUser: false,
      },
      {
        text: "I'm pretty flexible! Weekends work best for me",
        isFromCurrentUser: true,
      },
      {
        text: 'Awesome! How about this Saturday morning?',
        isFromCurrentUser: false,
      },
      {
      ...
      {
        text: "Me too! It'll be great to practice together 🧘‍♀️",
        isFromCurrentUser: false,
      },
    ],
  };
  ...
  const messages =
    messageTemplates[userId as keyof typeof messageTemplates] || [];
